...
from perm_context_window.model_loaders import load_permcw_wrapper
...
def run_permcw_experiment(dataset: str, model: str, cache_dir: str, subsample_test_set: int, output_dir: str,
    ...
    if n_shots_per_window is None:
        ...
        n_shots_per_window = get_max_n_shots(train_df, test_df, model.tokenizer, model.context_window_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', dest='model', action='store', default='openlm-research/open_llama_3b',
                        help='HF model name to use. Only support LLaMa family models')
